import pickle, sys
sys.path.append('../src')
from SIFmaster.src import data_io, sim_algo, eval, params
...
wordfiles = [#'../data/paragram_sl999_small.txt', # need to download it from John Wieting's github (https://github.com/jwieting/iclr2016)
    'helpers/glove.840B.300d.txt'  # need to download it first
    ]

weightfile = 'SIFmaster/auxiliary_data/enwiki_vocab_min200.txt'
