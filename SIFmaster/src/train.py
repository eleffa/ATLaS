...
from SIFmaster.src import params
import argparse
...
from SIFmaster.src import data_io
from SIFmaster.src import proj_model_sim
from SIFmaster.src import proj_model_sentiment
from SIFmaster.src import eval
