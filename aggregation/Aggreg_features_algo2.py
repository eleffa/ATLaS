...
def buildingTrainingSet2(lsi_align, vsm_align, lda_align, f1_align, f2_align, f3_align, f4_align, f5_align, f6_align,numLine,matrixSize=9):
  ...
  """  
    ...
    matrix_values0=building_aggreg_Matrix(lsi_align, vsm_align, lda_align, f1_align, f2_align, f3_align, f4_align, f5_align, f6_align,matrixSize)
...
def computeSimilarities2(lsi_align, vsm_align, lda_align, f1_align, f2_align, f3_align, f4_align, f5_align, f6_align,numLine,numRan=10):
    """ build the model with the semi supervised approach labelSpreading     
    Args:
    matrix_values: descriptor matrix i.e. all the probability of all ir models
    vect: the answer vector (value 0 for false links and 1 for true links);
  ...
  """ 
    ...
    for i in range(0,numRan):
        subVect,subMatrix_values,matrix_values = buildingTrainingSet2(lsi_align, vsm_align, lda_align, f1_align, f2_align, f3_align, f4_align, f5_align, f6_align,numLine)
...
def aggreg(lda,lsi,vsm, f1,f2, f3, f4, f5, f6,filename):
  ...
  Returns:
    ...
    pred_grd=computeSimilarities2(lsi_align, vsm_align, lda_align, f1_align, f2_align, f3_align, f4_align, f5_align, f6_align,numLine)
